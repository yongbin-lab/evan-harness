...
|------|--------|------|------|------|----------|
| 2026-03-29 | 링크드인 포스트 초안 — PM이 AI를 쓰는 법 | PM | PASS (7/7) | 0 | 3단 반전 Hook + AX 철학(0→65점) 자연 삽입. 1138자로 범위 내. 상황-행동-결과 구조(criteria.json 설계→주관 제거)로 구체성 확보 |
...
| 2026-04-03 | evan-harness 구조 리뷰 | PM | PASS (7/7) | 0 | 도구 제한 불일치·경로 패턴 혼재·미참조 자원 등 12건 발견. 요약 숫자 오류 등 경미한 concern 3건 |
...
| 2026-04-03 | 콴다앱 주간 데이터 리포트 v2 (Q2 OKR 재설계) | Hybrid | PASS (blocked 2건) | 0 | qanda_data_mart 5개 테이블 스키마 탐색. 결제/방문/질문 WoW+4주 이동평균 이상치 탐지. Slack MCP/cron 등록은 blocked |
...
| 2026-04-14 | 300만원 주식 배치 계획 (NAVER 매도 대금) | Trading | PASS (10/10, Fix 1회) | 0 | 전쟁주 제외 + 한국 비반도체/비자동차 제외 제약 하 STZ/NVO/CEG/IAU 4종목 분산. 4월 말 실적시즌 필터로 V/MA/LLY/BRK.B 희생, LLY→NVO 대체. 1회 Fix는 reviewer가 잡은 수치 오류 4건 |
| 2026-04-14 | 5종목 심층 분석 (MSFT/ORCL/STZ/LULU/CEG) | Trading | PASS (10/10) | 0 | 각 종목 11섹션 구조로 통일. ORCL AVOID(falling knife)/LULU HOLD(PFAS+EPS)/STZ·CEG BUY 유지, MSFT BUY 신규 추가(실적 후 5/1 진입 룰) |
| 2026-04-15 | persona-review 플러그인 구축 | Coding | PASS (10/10) | 0 | 산출물 타입 감지→3~5 페르소나 동적 생성→Task 병렬 리뷰→통합 파이프라인. 3 command+3 agent+1 skill. local-marketplace 등록 |
| 2026-04-15 | Education AI OS GTM/수익화 포지션 판단 | PM | 미검증 | 0 | "24시간 개인 선생님 케어" 포지션의 수익화 가능성 조건부 판단. 학원 대체재 전환 필요성 분석 |
| 2026-04-16 | 5종목 매수 각도 분석 (STZ/CEG/PLTR/ORCL/UNH) | Trading | PASS (10/10) | 0 | STZ BUY(즉시 4주)/CEG BUY(분할 2주)/PLTR AVOID(전쟁주+Fwd PE 102)/ORCL AVOID(falling knife)/UNH HOLD(9주 유지, 4/21 실적 후 재판단). 300만원 중 190만원 즉시, 잔여 113만원 대기 |
| 2026-04-16 | moodboard 디자인 컨셉 플러그인 구축 | Coding | PASS (10/10) | 0 | /moodboard로 제품 설명→trend-researcher(실시간 리서치)→concept-designer(3가지 축 무드보드) 파이프라인. 2 command+2 agent+1 skill. marketplace "design" 카테고리 등록 |
| 2026-04-16 | private 레포 README.md 생성 | PM | PASS (7/7, Fix 1회) | 0 | 레포 구조 파악→디렉토리 트리+역할 테이블+도구 스택 한글 README 생성. 1차 FAIL: gitignore 대상 유틸리티 스크립트 누락→추가 후 PASS |
| 2026-04-16 | Education AI OS 시장 소구 포인트 분석 v1 | PM | 미검증 | 0 | product-brief/prd/background/GTM 기반 소구 포인트 도출 |
| 2026-04-16 | Phase 4 병렬 워커 개발 레퍼런스 리서치 | PM | PASS (7/7) | 0 | Claude Code 공식 인프라 3가지+Anthropic 블로그 4건+GitHub 8개 레포 딥다이브. Subagent+worktree 기반 Dispatcher 패턴 권고. 비교표 4개(분할/격리/머지/실패)+5단계 구현 우선순위+비용 추정 포함 |
